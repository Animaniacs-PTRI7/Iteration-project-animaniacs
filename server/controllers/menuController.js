...
menuController.getSellerMenu = async (req, res, next) => {
  ...
  */
    ...
    const sqlQuery = `select d.pk_dish_id, 
  d.fk_seller_id, d.dish_name, d.description, 
  d.price, d.quantity_available,s.kitchen_name, 
  s.pickup_window_start, s.pickup_window_end, 
  s.cuisine, s.market_enabled, s.seller_street_name, 
  s.seller_city, s.seller_state, s.seller_zip_code
  FROM public.sellers s LEFT JOIN public.dishes d ON 
